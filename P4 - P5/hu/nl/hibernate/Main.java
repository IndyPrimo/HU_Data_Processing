...
public class Main {
	public static void main(String[] args) throws SQLException, ParseException {
		...
		if (create) {
			...
			Reiziger Julian = new Reiziger(6, "Julian", "", "Kunst", java.sql.Date.valueOf("1995-03-10"));

			OVChipkaart Julian_OV = new OVChipkaart(98765, java.sql.Date.valueOf("2019-12-31"), 1, 500f, Julian);
			Julian.setOVChipkaarten(new ArrayList<>(Collections.singletonList(Julian_OV)));

			ReizigerService.getInstance().persist(Julian);
